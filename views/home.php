<main>
    <section class="container_home">
        ...
        <div class="about">
            ...
            <p><strong>Hecho por Vicki</strong></p>
            <p><em>A mano en Argentina</em></p>
        </div>
